...
class PemesananController extends Controller
{
    public function index()
    {
        ...
        // Ambil data pemesanan user login dengan relasi kamar & homestay
        $pemesanan = Pemesanan::with(['kamar.homestay', 'pelanggan'])
    ...
    {
        $pemesanan = Pemesanan::with(['kamar.homestay', 'pelanggan', 'homestay'])
            ->findOrFail($id);
