<?php $__env->startSection('title', 'Daftar Pemilik Homestay'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        ...
        <a href="<?php echo e(route('admin.pendaftaran.pemilik')); ?>" 
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-white p-4 rounded-lg border border-gray-100 shadow-xs">
            ...
            <h3 class="text-xl md:text-2xl font-bold text-gray-800 mt-1"><?php echo e(count($pemilikList)); ?></h3>
        </div>
        
        <div class="bg-white p-4 rounded-lg border border-gray-100 shadow-xs">
            <p class="text-xs md:text-sm text-gray-500 font-medium">Aktif</p>
            <h3 class="text-xl md:text-2xl font-bold text-green-600 mt-1"><?php echo e($pemilikList->where('status', 'aktif')->count()); ?></h3>
        </div>
        
        <div class="bg-white p-4 rounded-lg border border-gray-100 shadow-xs">
            <p class="text-xs md:text-sm text-gray-500 font-medium">Nonaktif</p>
            <h3 class="text-xl md:text-2xl font-bold text-red-600 mt-1"><?php echo e($pemilikList->where('status', 'nonaktif')->count()); ?></h3>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-xs overflow-hidden border border-gray-100">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    <?php $__currentLoopData = $pemilikList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pemilik): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50 transition-colors duration-100">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-8 w-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 font-medium text-sm">
                                    <?php echo e(substr($pemilik->name, 0, 1)); ?>

                                </div>
                                <div class="ml-3">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($pemilik->name); ?></div>
                                    <div class="text-xs text-gray-400">ID: <?php echo e($pemilik->id); ?></div>
                                </div>
                            </div>
                        </td>
                        ...
                        <!-- Kontak -->
                        <td class="px-4 py-3 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($pemilik->email); ?></div>
                            <div class="text-xs text-gray-400"><?php echo e($pemilik->pemilikProfile->no_telepon ?? '-'); ?></div>
                        </td>
                        
                        <!-- Homestay -->
                        <td class="px-4 py-3">
                            <div class="flex flex-wrap gap-1 max-w-[180px]">
                                <?php $__empty_1 = true; $__currentLoopData = $pemilik->pemilikProfile->homestays ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homestay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <!-- Bergabung -->
                        <td class="px-4 py-3 whitespace-nowrap">
                            <div class="text-sm text-gray-700"><?php echo e($pemilik->created_at->translatedFormat('d M Y')); ?></div>
                            <div class="text-xs text-gray-400"><?php echo e($pemilik->created_at->diffForHumans()); ?></div>
                        </td>
                        
                        <!-- Status -->
                        <td class="px-4 py-3 whitespace-nowrap">
                            <?php if($pemilik->status == 'aktif'): ?>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                <?php if($pemilik->status == 'aktif'): ?>
                                    <form action="<?php echo e(route('admin.admin.nonaktifkan', $pemilik->id)); ?>" method="POST" onsubmit="return confirmNonaktifkan()">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php else: ?>
                                    <form action="<?php echo e(route('admin.admin.aktifkan', $pemilik->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PUT'); ?>
        ...
        <div class="px-4 py-3 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-3">
            <div class="text-xs text-gray-500">
                Menampilkan <span class="font-medium">1</span> sampai <span class="font-medium">10</span> dari <span class="font-medium"><?php echo e(count($pemilikList)); ?></span> hasil
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\US3R\Downloads\tamansari tourism\resources\views/admin/pemilikhomestay.blade.php ENDPATH**/ ?>