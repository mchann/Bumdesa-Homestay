                            ...
                            <div class="relative">
                                <select name="jenis_kamar_id" id="jenis_kamar_id" class="w-full pl-4 pr-10 py-3 border-2 border-green-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 bg-white text-gray-800 hover:border-green-300" required>
                                    ...
                                    <?php $__currentLoopData = $jenisKamars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($jenis->jenis_kamar_id); ?>" 
                                            <?php echo e($kamar->jenis_kamar_id == $jenis->jenis_kamar_id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_kamar" 
                                ...
                                value="<?php echo e(old('nama_kamar', $kamar->nama_kamar)); ?>" 
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-green-50 rounded-xl border border-green-200">
                                <?php $__currentLoopData = $fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="flex items-center p-3 bg-white rounded-lg border border-green-200 hover:border-green-300 hover:shadow-sm transition-all duration-200 cursor-pointer">
                                        ...
                                        <span class="ml-3 text-sm font-medium text-gray-700"><?php echo e($f->nama_fasilitas); ?></span>
                                    </label>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php echo $__env->make('layouts.pemilik', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\tamansari tourism\resources\views/pemilik/kamar/edit.blade.php ENDPATH**/ ?>