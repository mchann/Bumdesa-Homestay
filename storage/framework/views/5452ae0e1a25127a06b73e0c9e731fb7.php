                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-2" aria-labelledby="userDropdown" style="min-width: 220px;">
                        ...
                        <?php elseif(Auth::user()->role === 'pelanggan'): ?>
                            ...
                            <li><a class="dropdown-item py-2 px-3" href="<?php echo e(route('pelanggan.history')); ?>">
...
</style><?php /**PATH C:\Users\US3R\Downloads\tamansari tourism\resources\views/component/navbar.blade.php ENDPATH**/ ?>