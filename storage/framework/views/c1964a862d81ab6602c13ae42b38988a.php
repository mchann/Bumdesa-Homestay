                ...
                <div class="card-body text-center p-4">
                    <div class="avatar-wrapper mx-auto mb-3 position-relative">
                        <div class="avatar bg-gradient-primary text-white d-flex align-items-center justify-content-center" 
                            ...
                            <?php echo e(strtoupper(substr($profile->nama_lengkap ?? Auth::user()->name ?? 'U', 0, 1))); ?>

                        </div>
                    </div>
                    <h5 class="fw-bold mb-1"><?php echo e($profile->nama_lengkap ?? Auth::user()->name ?? 'Nama Pengguna'); ?></h5>
                    ...
                    <div class="list-group list-group-flush rounded-lg">
                        ...
                        <a href="<?php echo e(route('pelanggan.profile.update')); ?>" class="list-group-item list-group-item-action border-0 py-3 px-4 d-flex align-items-center">
        ...
        <div class="col-md-9">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom px-4 py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('pelanggan.profile.edit')); ?>" class="btn btn-primary px-4 py-2 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="p-3 bg-light rounded-lg border"><?php echo e($profile->nama_lengkap ?? Auth::user()->name ?? '-'); ?></div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label small text-muted mb-2">Country</label>
                            <div class="p-3 bg-light rounded-lg border"><?php echo e($profile->kewarganegaraan ?? '-'); ?></div>
                        </div>
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="p-3 bg-light rounded-lg border">
                                <?php if(isset($profile->jenis_kelamin)): ?>
                                    <?php if($profile->jenis_kelamin === 'Male'): ?>
                                        Laki-laki
                                    <?php elseif($profile->jenis_kelamin === 'Female'): ?>
                                        Perempuan
                                    <?php else: ?>
                                        -
                                    <?php endif; ?>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="p-3 bg-light rounded-lg border">
                                <?php if(isset($profile->tgl_lahir)): ?>
                                    <?php echo e(\Carbon\Carbon::parse($profile->tgl_lahir)->format('d F Y')); ?>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="p-3 bg-light rounded-lg border"><?php echo e(Auth::user()->email ?? '-'); ?></div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label small text-muted mb-2">Phone Number</label>
                            <div class="p-3 bg-light rounded-lg border"><?php echo e($profile->nomor_telepon ?? '-'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\US3R\Downloads\tamansari tourism\resources\views/pelanggan/profile.blade.php ENDPATH**/ ?>