            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body text-center p-4">
                    ...
                    <div class="list-group list-group-flush rounded-lg">
                        ...
                        <a href="<?php echo e(route('pelanggan.pemesanan.index')); ?>" class="list-group-item list-group-item-action border-0 py-3 px-4 d-flex align-items-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\tamansari tourism\resources\views/pelanggan/profile.blade.php ENDPATH**/ ?>