                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    ...
                                    <div class="property-rating text-end">
                                        ...
                                        <div class="text-muted small"><?php echo e($homestay->rating); ?> (<?php echo e($homestay->review_count); ?>)</div>
                                    </div>
                                </div>
                    ...
                    <div class="card border-0 h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <img src="<?php echo e(asset('img/haha.jpg')); ?>" class="rounded-circle me-3" width="50" height="50" alt="Testimonial 1">
                ...
                <div class="col-md-4">
                    <div class="card border-0 h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <img src="<?php echo e(asset('img/haha.jpg')); ?>" class="rounded-circle me-3" width="50" height="50" alt="Testimonial 2">
                                <div class="text-start">
                ...
                <div class="col-md-4">
                    <div class="card border-0 h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <img src="<?php echo e(asset('img/haha.jpg')); ?>" class="rounded-circle me-3" width="50" height="50" alt="Testimonial 3">
                                <div class="text-start">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\US3R\Downloads\tamansari tourism\resources\views/page/homestays.blade.php ENDPATH**/ ?>