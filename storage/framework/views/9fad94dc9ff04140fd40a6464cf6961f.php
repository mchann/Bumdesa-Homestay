...
<section id="destinasi" class="section bg-light">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="<?php echo e(asset('img/dialog.jpg')); ?>" class="card-img-top" alt="Air Terjun Tumpak Sewu">
                    <div class="card-body">
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\virda-cantik\homestay-bumdes\resources\views/page/home.blade.php ENDPATH**/ ?>