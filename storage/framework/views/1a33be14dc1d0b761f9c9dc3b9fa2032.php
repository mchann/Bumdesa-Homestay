...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div class="relative h-64 overflow-hidden">
                ...
                <img src="<?php echo e($kamar->foto_kamar ? asset('storage/'.$kamar->foto_kamar) : 'https://via.placeholder.com/600x400'); ?>" 
                     alt="<?php echo e($kamar->nama_kamar); ?>" 
                     class="w-full h-full object-cover transition-transform duration-500 hover:scale-105">
                
                <!-- Price Tag -->
                <div class="absolute bottom-4 left-4 z-20 bg-white/90 px-3 py-1 rounded-full shadow">
                    <span class="font-bold text-indigo-600">Rp <?php echo e(number_format($kamar->harga, 0, ',', '.')); ?></span>
                </div>
                
                <!-- Action Buttons -->
                <div class="absolute top-4 right-4 z-20 flex space-x-2">
                    <a href="<?php echo e(url('pemilik/kamar/' . $kamar->kamar_id . '/tutup')); ?>"
                    ...
                    <a href="<?php echo e(route('pemilik.kamar.edit', $kamar->kamar_id)); ?>" 
                    ...
                    <form action="<?php echo e(route('pemilik.kamar.destroy', $kamar->kamar_id)); ?>" method="POST">
            ...
            <div class="p-6">
                <div class="flex justify-between items-start">
                    <div>
                        <h3 class="text-xl font-bold text-gray-800"><?php echo e($kamar->nama_kamar); ?></h3>
                        <p class="text-sm text-gray-500 mt-1">
                            <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                            </svg>
                            <?php echo e($kamar->homestay->nama_homestay); ?>

                        </p>
                    </div>
                    <span class="bg-indigo-100 text-indigo-800 text-xs px-3 py-1 rounded-full font-medium">
                        <?php echo e($kamar->jenisKamar->nama_jenis ?? '-'); ?>
    ...
    <?php if($kamar->penutupanTerbaru): ?>
        <div class="mt-4 bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded-lg text-sm text-yellow-800">
            ...
            <?php echo e(\Carbon\Carbon::parse($kamar->penutupanTerbaru->start_date)->format('d M Y')); ?> - 
            <?php echo e(\Carbon\Carbon::parse($kamar->penutupanTerbaru->end_date)->format('d M Y')); ?><br>
            <span class="italic">Alasan: <?php echo e($kamar->penutupanTerbaru->alasan); ?></span>
        </div>
    <?php endif; ?>
                ...
                <div class="mt-4 flex items-center space-x-4 text-sm">
                    <span class="flex items-center text-gray-600">
                        ...
                        <?php echo e($kamar->kapasitas); ?> orang
                    </span>
                </div>
                ...
                <div class="mt-5 pt-4 border-t border-gray-100">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__empty_1 = true; $__currentLoopData = $kamar->fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.pemilik', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\File Tugas Dinaaaaaa\Tugas Smt 5\PAL\tamansari tourism\resources\views/pemilik/kamar/index.blade.php ENDPATH**/ ?>