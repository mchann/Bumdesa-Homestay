...
<div class="container py-5">
    <div class="text-center">
            ...
            <div class="card-body p-4">
                <div class="row text-start">
                    <div class="col-12 mb-3">
                        ...
                        <p class="fw-bold text-dark mb-0 fs-5"><?php echo e($invoice ?? 'INV-XXXXXX'); ?></p>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="text-muted small mb-1">Tanggal Pemesanan</label>
                        <p class="fw-bold text-dark mb-0"><?php echo e($tanggal ?? now()->format('d M Y, H:i')); ?></p>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-12">
                        ...
                        <p class="fw-bold text-success mb-0 fs-4">Rp <?php echo e($total ?? '0'); ?></p>
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            ...
            <a href="<?php echo e(route('pelanggan.cek-status')); ?>" class="btn btn-outline-success btn-lg px-4 rounded-pill">
                <i class="fas fa-search me-2"></i>Cek Status
            </a>
            <a href="<?php echo e(route('pelanggan.history')); ?>" class="btn btn-outline-primary btn-lg px-4 rounded-pill">
                <i class="fas fa-history me-2"></i>Lihat History
            </a>
            <?php if(isset($pemesanan_id)): ?>
            <a href="<?php echo e(route('pelanggan.pemesanan.detail', $pemesanan_id)); ?>" class="btn btn-outline-info btn-lg px-4 rounded-pill">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\US3R\Downloads\tamansari tourism\resources\views/pelanggan/pemesanan/pemesanan_success.blade.php ENDPATH**/ ?>