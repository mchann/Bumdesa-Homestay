...
<body>
    <div class="container">
        ...
        <div class="search-container">
            <form action="<?php echo e(route('umkm')); ?>" method="GET" class="search-bar">
                <input type="text" class="search-input" name="search" placeholder="Cari produk UMKM..." value="<?php echo e($searchQuery); ?>">
        ...
        <div class="category-filter">
            <a href="<?php echo e(route('umkm')); ?>?kategori=semua" 
               class="filter-btn <?php echo e($selectedCategory == 'semua' ? 'active' : ''); ?>">
                Semua Produk
            </a>
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('umkm')); ?>?kategori=<?php echo e($category); ?>" 
               class="filter-btn <?php echo e($selectedCategory == $category ? 'active' : ''); ?>">
                <?php echo e($category); ?>
        ...
        <?php if($products->count() > 0): ?>
            <div class="results-info">
                ...
                <?php if($selectedCategory != 'semua'): ?>
                    dalam kategori <?php echo e($selectedCategory); ?>

                <?php endif; ?>
                <?php if($searchQuery): ?>
                    untuk pencarian "<?php echo e($searchQuery); ?>"
                <?php endif; ?>
            </div>
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <div class="product-badge <?php echo e($product->badge == 'Baru' ? 'new' : 
                        ...
                        ($product->badge == 'Diskon' ? 'diskon' : ''))); ?>"><?php echo e($product->badge); ?></div>
                    <?php endif; ?>
                    ...
                    <div class="product-info">
                        <h3 class="product-title"><?php echo e($product->nama_produk); ?></h3>
                        
                        <div class="product-meta">
                            <span class="product-category"><?php echo e($product->kategori); ?></span>
                        ...
                        <div class="product-stats">
                            <div class="product-terjual">
                                ...
                                Terjual: <?php echo e($product->terjual); ?>
                        ...
                        <p class="product-desc"><?php echo e(Str::limit($product->deskripsi, 100)); ?></p>
                        
                        <div class="product-footer">
                            <span class="product-price">Rp <?php echo e(number_format($product->harga, 0, ',', '.')); ?></span>
                            <a href="<?php echo e(route('umkm.detail', $product->slug)); ?>" class="detail-btn">
                                Lihat Detail
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <?php if($selectedCategory != 'semua' || $searchQuery): ?>
                <a href="<?php echo e(route('umkm')); ?>" class="detail-btn" style="margin-top: 15px;">
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> UMKM Lokal Desa Tamansari.</p>
        </div>
    </div>
