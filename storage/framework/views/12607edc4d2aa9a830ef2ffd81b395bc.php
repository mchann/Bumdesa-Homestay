                            ...
                            <div class="relative">
                                <select name="homestay_id" class="w-full pl-3 pr-10 py-3 text-base border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 rounded-lg transition duration-150 bg-white text-gray-800" required>
                                    <?php $__currentLoopData = $homestays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homestay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($homestay->homestay_id); ?>" class="text-gray-800"><?php echo e($homestay->nama_homestay); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_kamar" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 bg-white text-gray-800" value="<?php echo e(old('nama_kamar')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="kapasitas" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 bg-white text-gray-800" value="<?php echo e(old('kapasitas')); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="harga" class="w-full pl-10 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 bg-white text-gray-800" value="<?php echo e(old('harga')); ?>" step="1000" required>
                            </div>
...
<?php echo $__env->make('layouts.pemilik', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\pengabdian\homestay-bumdes\resources\views/pemilik/kamar/create.blade.php ENDPATH**/ ?>