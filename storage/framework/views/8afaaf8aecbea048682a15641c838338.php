                    ...
                    <div class="row g-0">
                        <div class="col-md-4 position-relative">
                            ...
                            <div class="position-absolute top-0 end-0 m-2">
                               <?php if($firstKamar->status == 'tersedia'): ?>
                                <span class="badge bg-success">Available (<?php echo e($stok); ?>)</span>
                                <?php else: ?>
              ...
              <div class="col-md-4 mb-3">
                <div class="border rounded-4 p-3 h-100">
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <span class="fw-bold"><?php echo e($review['title']); ?></span>
                  </div>
                  <p class="small mb-2 text-muted"><?php echo e($review['comment']); ?></p>
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\homestay-bumdes\resources\views/page/homestay_detail.blade.php ENDPATH**/ ?>