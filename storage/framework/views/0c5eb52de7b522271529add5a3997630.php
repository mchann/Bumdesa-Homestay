        ...
        <aside class="w-64 bg-black text-white flex flex-col">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 text-sm">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="<?php echo e(route('admin.fasilitas.index')); ?>" class="flex items-center p-2 rounded hover:bg-gray-700 transition">
                ...
                <div class="dropdown">
                    <button class="dropdown-toggle flex items-center justify-between w-full p-2 rounded hover:bg-gray-800 transition">
                        <div class="flex items-center">
                            <!-- Updated Icon for Homestay Jenis Kamar -->
                            <span class="material-icons mr-2">home</span> Jenis Kamar
                        </div>
                        <span class="dropdown-arrow material-icons transition-transform">expand_more</span>
                    </button>                                       
                    <div class="dropdown-content">
                        <a href="<?php echo e(route('admin.jenis-kamar.index')); ?>" class="flex items-center p-2 rounded hover:bg-gray-700 transition">
                            <span class="material-icons mr-2">list</span> Jenis Kamar
                        </a>
                    </div>
                </div>
...
</html><?php /**PATH E:\File Tugas Dinaaaaaa\Tugas Smt 5\PAL\tamansari tourism\resources\views/layouts/admin.blade.php ENDPATH**/ ?>