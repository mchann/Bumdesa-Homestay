    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white p-5 rounded-xl shadow-md">
            ...
            <div class="text-2xl font-bold text-green-600">
                <?php echo e($totalPemesananFilter ?? 0); ?>
        ...
        <div class="bg-white p-5 rounded-xl shadow-md">
            ...
            <div class="text-2xl font-bold text-green-600">
                <?php echo e($totalPemesananBerhasilFilter ?? 0); ?>
        ...
        <div class="bg-white p-5 rounded-xl shadow-md">
            ...
            <div class="text-2xl font-bold text-green-600">
                Rp<?php echo e(number_format($totalPendapatanFilter ?? 0, 0, ',', '.')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\tamansari tourism\resources\views/admin/pemesanan/index.blade.php ENDPATH**/ ?>