    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden card-hover">
            ...
            <div class="p-6">
                <?php if($errors->any()): ?>
                    <div class="bg-red-50 border-l-4 border-red-500 p-4 rounded-lg mb-6">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-red-800">Terdapat <?php echo e($errors->count()); ?> kesalahan yang perlu diperbaiki</h3>
                ...
                <form action="<?php echo e(route('pemilik.homestay.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="deskripsi" 
                                      class="pl-10 w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                      placeholder="Jelaskan keunikan dan fasilitas homestay Anda..." rows="4"><?php echo e(old('deskripsi')); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="alamat_homestay" required 
                                      class="pl-10 w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                      placeholder="Masukkan alamat lengkap homestay..." rows="3"><?php echo e(old('alamat_homestay')); ?></textarea>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.pemilik', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\US3R\Downloads\tamansari tourism\resources\views/pemilik/homestay/create.blade.php ENDPATH**/ ?>