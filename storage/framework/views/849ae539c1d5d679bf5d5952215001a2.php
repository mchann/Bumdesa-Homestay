    ...
    <div class="row">
                    ...
                    <form action="<?php echo e(route('pelanggan.pemesanan.store')); ?>" method="POST">
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-end">Rp <?php echo e(number_format($hargaPerMalam, 0, ',', '.')); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Duration</td>
                                            <td class="text-end"><?php echo e($jumlahMalam); ?> night(s)</td>
                                        </tr>
                                        <tr>
                                            <td>Room Subtotal</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end"><?php echo e($jumlahKamar); ?></td>
                                        </tr>
                                        <tr class="border-top">
                                            <td class="fw-bold">Total Payment</td>
                                            <td class="text-end fw-bold">Rp <?php echo e(number_format($totalHarga, 0, ',', '.')); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="mb-4 border-top pt-4">
                            ...
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle me-2"></i> Stay duration: <?php echo e($jumlahMalam); ?> night(s)
                            </div>
                        </div>

                        <div class="mb-4 border-top pt-4">
                            <h5 class="mb-3">You choose</h5>
                            <p class="fw-bold"><?php echo e($jumlahKamar); ?> rooms for <?php echo e($totalTamu); ?> guests (<?php echo e($dewasa ?? 0); ?> adults, <?php echo e($anak ?? 0); ?> children)</p>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-3 sticky-top" style="top: 20px;">
                <div class="card-header bg-white border-0 py-3">
                    <h4 class="mb-0"><i class="fas fa-home me-2"></i><?php echo e($homestay->nama_homestay ?? 'Homestay'); ?></h4>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><i class="fas fa-user-friends text-muted me-2"></i> Capacity: <?php echo e($kamar->kapasitas ?? '-'); ?> guests</li>
                        <?php if($kamar->ukuran_kamar): ?>
                            <li class="mb-2"><i class="fas fa-arrows-alt text-muted me-2"></i> Size: <?php echo e($kamar->ukuran_kamar); ?> m²</li>
                        <?php endif; ?>
                        ...
                        <li class="mb-2"><i class="fas fa-door-closed text-muted me-2"></i> Rooms: <?php echo e($jumlahKamar); ?></li>
                        <li class="mb-2"><i class="fas fa-user text-muted me-2"></i> Adults: <?php echo e($dewasa ?? 0); ?></li>
                        <li class="mb-2"><i class="fas fa-child text-muted me-2"></i> Children: <?php echo e($anak ?? 0); ?></li>
                    </ul>
                    ...
                    <div class="border-top pt-3 mt-3">
                        ...
                        <table class="table table-sm table-borderless">
                            ...
                            <tr>
                                <td>Nights</td>
                                <td class="text-end"><?php echo e($jumlahMalam); ?></td>
                            </tr>
                            <tr>
                                <td>Room Subtotal</td>
                                <td class="text-end">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\homestay-bumdes\resources\views/pelanggan/pemesanan/create.blade.php ENDPATH**/ ?>