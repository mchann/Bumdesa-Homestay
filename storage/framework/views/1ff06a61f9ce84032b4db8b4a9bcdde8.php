        ...
        <aside class="w-64 bg-black text-white flex flex-col">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 text-sm">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                         <a href="<?php echo e(route('pemilik.jenis-kamar.index')); ?>" class="flex items-center p-2 rounded hover:bg-gray-700 transition">
...
</html><?php /**PATH C:\xampp\htdocs\homestay-bumdes\resources\views/layouts/pemilik.blade.php ENDPATH**/ ?>