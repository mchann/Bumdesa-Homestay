...
<style>
    ...
    .hero-section {
        background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), 
                    url('<?php echo e(asset('img/car-ijen.jpeg')); ?>');
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <img src="<?php echo e(asset('img/car-ijen.jpeg')); ?>" alt="Kawah Ijen" class="img-fluid rounded shadow">
            </div>
            <div class="col-lg-6">
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\virda-cantik\homestay-bumdes\resources\views/page/destinations/ijencrater.blade.php ENDPATH**/ ?>