...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?php echo e(route('admin.umkm.create')); ?>" class="btn btn-success shadow-sm px-4 py-2">
            ...
            <form action="<?php echo e(route('admin.umkm.index')); ?>" method="GET">
                <div class="row g-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end gap-2">
                        ...
                        <a href="<?php echo e(route('admin.umkm.index')); ?>" class="btn btn-outline-success">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(count($categories)); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <table class="table table-hover mb-0" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr class="align-middle">
                            ...
                            <td>
                                <div class="fw-semibold text-dark"><?php echo e($product->nama_produk); ?></div>
                                <?php if($product->badge): ?>
                                    <span class="badge badge-custom mt-1"><?php echo e($product->badge); ?></span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <span class="badge bg-light text-dark border"><?php echo e($product->kategori); ?></span>
                            </td>
                            <td>
                                <span class="fw-bold text-success">Rp <?php echo e(number_format($product->harga, 0, ',', '.')); ?></span>
                            </td>
                            <td>
                                <?php if($product->stok > 20): ?>
                                    <span class="badge bg-success"><?php echo e($product->stok); ?></span>
                                <?php elseif($product->stok > 5): ?>
                                    <span class="badge bg-warning text-dark"><?php echo e($product->stok); ?></span>
                                <?php else: ?>
                                    <span class="badge bg-danger"><?php echo e($product->stok); ?></span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <select class="form-select status-select border-0 shadow-sm <?php echo e($product->status == 'active' ? 'bg-success-light text-success' : 'bg-danger-light text-danger'); ?>" 
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-muted"><?php echo e($product->no_telepon_owner ?? '-'); ?></span>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="<?php echo e(route('admin.umkm.edit', $product->id)); ?>" 
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-5">
                                <div class="empty-state">
                                    ...
                                    <a href="<?php echo e(route('admin.umkm.create')); ?>" class="btn btn-success mt-2">
