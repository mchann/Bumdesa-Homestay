...
<?php $__env->startSection('title', 'Simulasi Pembayaran'); ?>
...
<div class="container mt-5">
    <div class="card shadow p-4">
        ...
        <div class="d-flex align-items-center mb-4">
            <img src="<?php echo e(asset('img/bca.png')); ?>" alt="Logo BCA" height="40" class="me-3">
        ...
        <ol class="mb-4">
            ...
            <li>Pastikan jumlah nominal: <strong class="text-success">Rp <?php echo e(number_format($pemesanan->total_harga + 4500, 0, ',', '.')); ?></strong></li>
...
const timer = setInterval(() => {
    ...
    if (seconds <= 0) {
        clearInterval(timer);
        window.location.href = "<?php echo e(route('pemesanan.success', ['id' => $pemesanan->pemesanan_id])); ?>";
    }
}, 1000);
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tamansari tourism\resources\views/pelanggan/pembayaran/simulasi.blade.php ENDPATH**/ ?>