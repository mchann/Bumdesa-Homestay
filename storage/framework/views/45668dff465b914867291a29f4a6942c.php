...
<style>
    ...
    .hero-section {
        background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), 
                    url('<?php echo e(asset('img/car-terakota.jpg')); ?>');
...
<section id="about" class="section bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="<?php echo e(asset('img/car-terakota.jpg')); ?>" alt="Gandrung Terracotta Park" class="img-fluid rounded shadow">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row g-3">
            <div class="col-md-4 col-6">
                <img src="<?php echo e(asset('img/car-terakota.jpg')); ?>" class="gallery-img" alt="Patung Gandrung">
            </div>
            <div class="col-md-4 col-6">
                <img src="<?php echo e(asset('img/car-terakota.jpg')); ?>" class="gallery-img" alt="Tarian Gandrung">
            </div>
            <div class="col-md-4 col-6">
                <img src="<?php echo e(asset('img/car-terakota.jpg')); ?>" class="gallery-img" alt="Landscape Taman">
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\pengabdian\homestay-bumdes\resources\views/page/destinations/gandrung.blade.php ENDPATH**/ ?>