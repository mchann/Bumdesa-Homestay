    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-black text-white flex flex-col">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 text-sm">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center p-2 rounded hover:bg-gray-800 transition">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="<?php echo e(route('admin.pemilik.list')); ?>" class="flex items-center p-2 rounded hover:bg-gray-700 transition">
                ...
                <!-- Fasilitas -->
                <a href="<?php echo e(route('admin.fasilitas.index')); ?>" class="flex items-center w-full p-2 rounded hover:bg-gray-800 transition">
                    <span class="material-icons mr-2">apartment</span> Fasilitas Homestay
                </a>

                <!-- Jenis Kamar -->
                <a href="<?php echo e(route('admin.jenis-kamar.index')); ?>" class="flex items-center w-full p-2 rounded hover:bg-gray-800 transition">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="<?php echo e(route('admin.peraturan.index')); ?>" class="flex items-center p-2 rounded hover:bg-gray-700 transition">
                            <span class="material-icons mr-2">list</span> Daftar Peraturan
                        </a>
                    </div>
                </div>
                
                <a href="<?php echo e(route('admin.pemesanan.index')); ?>" class="flex items-center p-2 rounded hover:bg-gray-800 transition">
                    <span class="material-icons mr-2">payment</span> Pemesanan
                </a>
                
                
                <!-- UMKM Products -->
                <a href="<?php echo e(route('admin.umkm.index')); ?>" class="flex items-center p-2 rounded hover:bg-gray-800 transition">
                    <span class="material-icons mr-2">store</span> Produk UMKM
                </a>

                <!-- MENU BARU: Ulasan -->
                <a href="<?php echo e(route('admin.ulasan.index')); ?>" class="flex items-center p-2 rounded hover:bg-gray-800 transition">
...
<?php /**PATH C:\Users\US3R\Downloads\new before pull\tamansari tourism\resources\views/layouts/admin.blade.php ENDPATH**/ ?>