...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top py-lg-2 py-1">
    ...
    <li><hr class="dropdown-divider"></li>
                ...
                <li class="nav-item">
    <a href="<?php echo e(route('UMKM')); ?>" class="nav-link text-light px-lg-3 px-2 py-2 rounded <?php echo e(request()->routeIs('UMKM') ? 'active bg-gradient-primary' : ''); ?>">
        <span class="position-relative">
            UMKM
            <span class="position-absolute bottom-0 start-0 w-0 h-1 bg-primary transition-all" style="transition-duration: 0.3s;"></span>
        </span>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-2" aria-labelledby="userDropdown" style="min-width: 220px;">
                        ...
                        <?php elseif(Auth::user()->role === 'pelanggan'): ?>
                            ...
                            <li><a class="dropdown-item py-2 px-3" href="<?php echo e(route('pelanggan.pemesanan.index')); ?>">
...
</style><?php /**PATH E:\File Tugas Dinaaaaaa\Tugas Smt 5\PAL\tamansari tourism\resources\views/component/navbar.blade.php ENDPATH**/ ?>