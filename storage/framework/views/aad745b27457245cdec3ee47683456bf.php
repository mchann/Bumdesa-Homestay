                ...
                <div class="col-md-8">
                    <div class="p-3 h-100 d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-between align-items-end">
                            ...
                            <a href="<?php echo e($bookUrl); ?>" 
                               class="btn <?php echo e($buttonClass); ?> rounded-pill px-4"
                               <?php if(!$datesFilled): ?> onclick="event.preventDefault(); alert('Please fill in the Check-in and Check-out dates first.');" <?php endif; ?>
                               >
                                <?php echo $buttonText; ?>
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PEBEL\SANGAT PAGI\tamansari tourism\resources\views/page/homestay_detail.blade.php ENDPATH**/ ?>