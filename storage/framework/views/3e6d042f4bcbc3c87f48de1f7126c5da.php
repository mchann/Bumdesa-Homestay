                                        ...
                                        <tr class="border-bottom">
                                            ...
                                            <td>
                                                <span class="badge bg-<?php echo e($item->status_badge_class); ?> rounded-pill px-3 py-2">
                                                    <i class="fas fa-<?php echo e($item->status == 'selesai' ? 'check' : ($item->status == 'dibatalkan' ? 'times' : 'clock')); ?> me-1"></i>
                                                    <?php echo e($item->status_label); ?>

                                                </span>
                                                <?php if($item->status == 'pending' && $item->batas_pembayaran): ?>
                                                    <br>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\tamansari tourism\resources\views/pelanggan/pemesanan/history.blade.php ENDPATH**/ ?>