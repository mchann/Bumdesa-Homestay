    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 p-6 text-white">
            <div class="flex justify-between items-start">
                <div>
                    <h2 class="text-2xl font-bold">Pemesanan #{{ $pemesanan->pemesanan_id }}</h2>
                    <p class="text-green-100">{{ date('d M Y, H:i', strtotime($pemesanan->created_at)) }}</p>
                </div>
                ...
                <div class="bg-gray-50 p-5 rounded-lg border border-green-100">
                    ...
                    <div class="space-y-2">
                        <p class="flex items-start">
                            ...
                            <span class="text-gray-800 font-medium">{{ $pemesanan->pelanggan->name ?? '-' }}</span>
                        </p>
                        <p class="flex items-start">
                            <span class="text-gray-600 w-24 flex-shrink-0">Email</span>
                            <span class="text-gray-800 font-medium">{{ $pemesanan->pelanggan->email ?? '-' }}</span>
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-5 rounded-lg border border-green-100">
                    ...
                    <div class="space-y-2">
                        <p class="flex items-start">
                            ...
                            <span class="text-gray-800 font-medium">{{ $pemesanan->kamar->homestay->nama_homestay ?? '-' }}</span>
                        </p>
                        <p class="flex items-start">
                            <span class="text-gray-600 w-24 flex-shrink-0">Kamar</span>
                            <span class="text-gray-800 font-medium">{{ $pemesanan->kamar->nama_kamar ?? '-' }}</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-gray-50 p-5 rounded-lg border border-green-100">
                    ...
                    <p class="text-xl font-medium text-gray-800">
                        {{ date('d M Y, H:i', strtotime($pemesanan->tgl_check_in)) }}
                    </p>
                </div>
                ...
                <div class="bg-gray-50 p-5 rounded-lg border border-green-100">
                    ...
                    <p class="text-xl font-medium text-gray-800">
                        {{ date('d M Y, H:i', strtotime($pemesanan->tgl_check_out)) }}
                    </p>
                </div>
            </div>
