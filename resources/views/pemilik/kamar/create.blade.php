                ...
                <form action="{{ route('pemilik.kamar.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-grid">
                            ...
                            <div class="input-group">
                                <select name="jenis_kamar_id" id="jenis_kamar_id" required>
                                    ...
                                    @foreach ($jenisKamars as $jenis)
                                        <option value="{{ $jenis->jenis_kamar_id }}">{{ $jenis->nama_jenis }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_kamar" id="nama_kamar" value="{{ old('nama_kamar') }}" required>
                            @error('nama_kamar')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="kapasitas" id="kapasitas" value="{{ old('kapasitas') }}" min="1" required>
                            @error('kapasitas')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="harga" id="harga" class="input-with-icon" value="{{ old('harga') }}" step="1000" required>
                            </div>
                            @error('harga')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                            ...
                            <div class="facilities-grid">
                                @foreach($fasilitas as $f)
                                    <div class="facility-item">
                                        <input type="checkbox" name="fasilitas[]" value="{{ $f->fasilitas_id }}" id="facility-{{ $f->fasilitas_id }}" 
                                            {{ in_array($f->fasilitas_id, old('fasilitas', [])) ? 'checked' : '' }}>
                                        <label for="facility-{{ $f->fasilitas_id }}">{{ $f->nama_fasilitas }}</label>
                                    </div>
                                @endforeach
                            </div>
                            @error('fasilitas')
