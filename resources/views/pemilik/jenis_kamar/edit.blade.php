...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Jenis Kamar</h2>

        <form action="{{ route('pemilik.jenis-kamar.update', $jenis_kamar->jenis_kamar_id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nama_jenis" id="nama_jenis" 
                       value="{{ old('nama_jenis', $jenis_kamar->nama_jenis) }}"
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit" 
                        class="inline-block bg-blue-600 text-white px-6 py-2 rounded-lg shadow-lg hover:bg-blue-700 transition duration-200 ease-in-out transform hover:scale-105">
                    Perbarui
                </button>
            </div>
        </form>
