...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="mobile-sidebar fixed top-0 left-0 w-64 h-full bg-black text-white z-50 md:hidden" id="mobileSidebar">
        <div class="flex items-center justify-between h-16 border-b border-gray-700 px-4">
            <img src="{{ asset('img/logo-tamansari.png') }}" alt="Logo Homestay" class="h-10">
            <button class="text-white p-2" id="closeMobileSidebar">
                <i class="fas fa-times text-xl"></i>
            </button>
        </div>
        <nav class="flex-1 px-4 py-4 space-y-1 text-sm">
            <a href="{{ route('pemilik.dashboard') }}" class="flex items-center p-2 rounded hover:bg-gray-800 transition" onclick="closeMobileSidebar()">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="{{ route('pemilik.homestay.index') }}" class="flex items-center p-2 rounded hover:bg-gray-700 transition" onclick="closeMobileSidebar()">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="{{ route('pemilik.kamar.index') }}" class="flex items-center p-2 rounded hover:bg-gray-700 transition" onclick="closeMobileSidebar()">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="{{ route('pemilik.pemesanan.index') }}" class="flex items-center p-2 rounded hover:bg-gray-700 transition" onclick="closeMobileSidebar()">
                        <span class="material-icons mr-2">list</span> Daftar Pemesanan
                    </a>
                </div>
            </div>
            
            <a href="{{ route('pemilik.ulasan.index') }}" class="flex items-center p-2 rounded hover:bg-gray-800 transition" onclick="closeMobileSidebar()">
            ...
            <div class="border-t border-gray-700 pt-4 mt-4 user-info-mobile">
                <div class="flex items-center space-x-3 p-2">
                    ...
                    <div class="text-left">
                        ...
                        <div class="text-gray-400 text-xs">{{ Auth::user()->role ?? 'User' }}</div>
                    </div>
                </div>
                <div class="mt-2 space-y-1">
                    <a href="{{ route('pemilik.profile.show') }}" class="flex items-center p-2 rounded hover:bg-gray-800 transition text-sm" onclick="closeMobileSidebar()">
                        <i class="fas fa-user mr-3 text-gray-400"></i> Profil
                    </a>
                    <a href="{{ route('home') }}" class="flex items-center p-2 rounded hover:bg-gray-800 transition text-sm" onclick="closeMobileSidebar()">
    ...
    <div class="min-h-screen flex">
        ...
        <aside class="desktop-sidebar w-64 bg-black text-white flex-col hidden md:flex">
            ...
            <nav class="flex-1 px-4 py-4 space-y-2 text-sm">
                <a href="{{ route('pemilik.dashboard') }}" class="flex items-center p-2 rounded hover:bg-gray-800 transition">
                    <span class="material-icons mr-2">dashboard</span> Dashboard
                </a>
                ...
                <div class="dropdown relative">
                    ...
                    <div class="dropdown-content">
                        <a href="{{ route('pemilik.homestay.index') }}" class="flex items-center p-2 rounded hover:bg-gray-700 transition">
                            <span class="material-icons mr-2">list</span> Homestay Anda
                        </a>
                    </div>
                </div>
                ...
                <a href="{{ route('pemilik.ulasan.index') }}" class="flex items-center p-2 rounded hover:bg-gray-800 transition">
                    <span class="material-icons mr-2">reviews</span> Ulasan
                </a>
