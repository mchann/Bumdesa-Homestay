    ...
    <div class="min-h-screen flex">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 text-sm">
                ...
                <div class="dropdown">
                    <button class="dropdown-toggle flex items-center justify-between w-full p-2 rounded hover:bg-gray-800 transition">
                        ...
                        <span class="dropdown-arrow material-icons transition-trnsform">expand_more</span>
                    </button>
                    <div class="dropdown-content">
                        ...
                        {{-- <a href="{{ route('pemilik.homestay.create') }}" class="flex items-center p-2 rounded hover:bg-gray-700 transition">
                            <span class="material-icons mr-2">add</span> Tambah Homestay
                        </a> --}}
                    </div>
                </div>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="bg-white shadow-md px-6 py-4 flex justify-between items-center">
                <h1 class="text-xl font-semibold text-gray-800">Selamat Datang, Pemilik</h1>
