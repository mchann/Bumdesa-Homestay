        ...
        <div class="bg-white p-4 rounded-3 shadow-sm">
            <form method="POST" action="{{ route('login') }}" novalidate>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('password.request') }}" class="text-decoration-none" style="color: #000000; font-weight: 500;">Forgot Password?</a>
                </div>
                ...
                <div class="text-center mb-4">
                    <p class="text-muted">Don't have an account? 
                        <a href="{{ route('register') }}" class="text-decoration-none fw-medium" style="color: #2e8b57;">Register here</a>
                    </p>
                </div>
...
{{-- JavaScript langsung di bagian bawah halaman --}}
<script>
