                    ...
                    <div>
                        ...
                        <div class="btn-group me-2">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="{{ route('pelanggan.invoice.download', ['id' => $pemesanan->pemesanan_id, 'type' => 'pdf']) }}">
                        ...
                        <a href="{{ route('pelanggan.history') }}" class="btn btn-outline-light btn-sm rounded-pill">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="border rounded-3 p-3 bg-light">
                                    ...
                                    <p class="h4 text-success fw-bold">{{ $pemesanan->invoice_number }}</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="border rounded-3 p-3 bg-light">
                                    <h6 class="text-muted mb-2">Tanggal Pemesanan</h6>
                                    <p class="h5 text-dark">{{ $pemesanan->created_at->format('d M Y, H:i') }}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="border rounded-3 p-4 bg-light">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="badge bg-{{ $pemesanan->status_badge_class }} fs-6 px-4 py-2 me-3 rounded-pill">
                                            <i class="fas fa-{{ $pemesanan->status == 'selesai' ? 'check' : ($pemesanan->status == 'dibatalkan' ? 'times' : 'clock') }} me-2"></i>
                                            {{ $pemesanan->status_label }}
                                        </span>
                                        @if($pemesanan->status == 'pending' && $pemesanan->batas_pembayaran)
                                            <div class="flex-grow-1">
                                                <small class="text-muted d-block">
                                                    <i class="fas fa-clock me-1"></i>
                                                    Batas pembayaran: {{ \Carbon\Carbon::parse($pemesanan->batas_pembayaran)->format('d M Y, H:i') }}
                                                </small>
                                                @if($pemesanan->sudah_kadaluarsa)
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="border rounded-3 p-4 bg-light">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <h5 class="text-success mb-3">{{ $pemesanan->kamar->nama_kamar ?? 'N/A' }}</h5>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p class="mb-2">
                                                        <i class="fas fa-home me-2 text-success"></i>
                                                        <strong>Homestay:</strong> {{ $pemesanan->kamar->homestay->nama_homestay ?? 'N/A' }}
                                                    </p>
                                                    <p class="mb-2">
                                                        <i class="fas fa-map-marker-alt me-2 text-success"></i>
                                                        <strong>Alamat:</strong> {{ $pemesanan->kamar->homestay->alamat ?? 'N/A' }}
                                                    </p>
                                                </div>
                                                <div class="col-md-6">
                                                    <p class="mb-2">
                                                        <i class="fas fa-phone me-2 text-success"></i>
                                                        <strong>Telepon:</strong> {{ $pemesanan->kamar->homestay->telepon ?? 'N/A' }}
                                                    </p>
                                                    <p class="mb-0">
                                                        <i class="fas fa-door-closed me-2 text-success"></i>
                                                        <strong>Tipe Kamar:</strong> {{ $pemesanan->kamar->jenisKamar->nama_jenis ?? 'Standard' }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 text-center">
                                            @if($pemesanan->kamar->foto_kamar)
                                                <img src="{{ asset('storage/'.$pemesanan->kamar->foto_kamar) }}" 
                                                     class="img-fluid rounded-3 shadow-sm" 
                                                     style="max-height: 120px; object-fit: cover;"
                                                     alt="{{ $pemesanan->kamar->nama_kamar }}">
                                            @else
                                ...
                                <div class="border rounded-3 p-4 bg-light h-100">
                                    ...
                                    <div class="text-center">
                                        <div class="mb-3">
                                            ...
                                            <p class="h6 mb-1">{{ \Carbon\Carbon::parse($pemesanan->tgl_check_in)->format('d M Y') }}</p>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <p class="h6 mb-1">{{ \Carbon\Carbon::parse($pemesanan->tgl_check_out)->format('d M Y') }}</p>
                                            <small class="text-muted">Sebelum 12:00</small>
                                        </div>
                                        <div>
                                            <i class="fas fa-moon fa-2x text-success mb-2"></i>
                                            <h5 class="text-success">Durasi</h5>
                                            <p class="h6 mb-1">{{ $pemesanan->lama_menginap }} Malam</p>
                                ...
                                <div class="border rounded-3 p-4 bg-light h-100">
                                    ...
                                    <div class="text-center">
                                        <div class="mb-3">
                                            ...
                                            <p class="h6 mb-1">{{ $pemesanan->jumlah_tamu }} Orang</p>
                            ...
                            <div class="col-12">
                                <div class="border rounded-3 p-4 bg-light">
                                    ...
                                    <div class="bg-white rounded-3 p-3 border">
                                        <p class="mb-0 text-dark">{{ $pemesanan->catatan }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="bg-white rounded-3 p-4 border">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <span class="fw-medium">Rp {{ $pemesanan->total_harga_formatted }}</span>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <span class="fw-medium">Rp {{ $pemesanan->biaya_tambahan_formatted }}</span>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <h4 class="text-success mb-0">Rp {{ $pemesanan->total_akhir_formatted }}</h4>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-center gap-3 flex-wrap">
                                    @if($pemesanan->status == 'pending' && !$pemesanan->sudah_kadaluarsa)
                                        <a href="{{ route('pelanggan.pemesanan.bayar', $pemesanan->pemesanan_id) }}" 
                                    ...
                                    <a href="{{ route('pelanggan.cek-status') }}" class="btn btn-outline-primary rounded-pill px-4">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <div class="d-flex justify-content-center gap-3">
                                <a href="{{ route('pelanggan.history') }}" class="btn btn-success rounded-pill px-4">
