                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="border rounded-3 p-3 bg-light">
                                    ...
                                    <p class="h5 text-success fw-bold">{{ $pemesanan->invoice_number }}</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="border rounded-3 p-3 bg-light">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="border rounded-3 p-4 bg-light">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <h5 class="text-dark mb-3">{{ $pemesanan->kamar->nama_kamar ?? 'N/A' }}</h5>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p class="mb-2">
                                                    ...
                                                    <p class="mb-2">
                                                        ...
                                                        <strong>Check-in:</strong> {{ \Carbon\Carbon::parse($pemesanan->tgl_check_in)->format('d M Y') }}
                                                    </p>
                                                    <p class="mb-0">
                                                        <i class="fas fa-users me-2 text-success"></i>
                                                        <strong>Tamu:</strong> {{ $pemesanan->jumlah_tamu }} orang
                                                    </p>
                                                </div>
                                                <div class="col-md-6">
                                                    <p class="mb-2">
                                                        <i class="fas fa-door-closed me-2 text-success"></i>
                                                        <strong>Kamar:</strong> {{ $pemesanan->jumlah_kamar }} unit
                                                    </p>
                                                    <p class="mb-2">
                                                        <i class="fas fa-calendar-times me-2 text-success"></i>
                                                        <strong>Check-out:</strong> {{ \Carbon\Carbon::parse($pemesanan->tgl_check_out)->format('d M Y') }}
                                                    </p>
                                                    <p class="mb-0">
                                                        <i class="fas fa-moon me-2 text-success"></i>
                                                        <strong>Durasi:</strong> {{ $pemesanan->lama_menginap }} malam
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 text-md-end">
                                            ...
                                            <div class="bg-white border rounded-3 p-3">
                                                ...
                                                <div class="d-flex justify-content-between mb-2">
                                                    ...
                                                    <span class="small">Rp {{ $pemesanan->total_harga_formatted }}</span>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-between mb-2">
                                                    ...
                                                    <span class="small">Rp {{ $pemesanan->biaya_tambahan_formatted }}</span>
                                                </div>
                                                
                                                <hr class="my-2">
                                                <div class="d-flex justify-content-between fw-bold">
                                                    <span class="text-success">Total</span>
                                                    <span class="text-success">Rp {{ $pemesanan->total_akhir_formatted }}</span>
                                                </div>
                                        ...
                                        @foreach($steps as $statusKey => $step)
                                            ...
                                            <div class="timeline-item {{ $isActive ? 'active' : '' }} {{ $isCurrent ? 'current' : '' }}">
                                                ...
                                                <div class="timeline-content">
                                                    <h6 class="{{ $isActive ? 'text-success' : 'text-muted' }}">
                                                        {{ $step['title'] }}
                                                        @if($isCurrent)
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="{{ route('pelanggan.history') }}" class="btn btn-outline-success rounded-pill px-4">
                                    ...
                                    <div>
                                        ...
                                        @endif
                                        <a href="{{ route('pelanggan.pemesanan.detail', $pemesanan->pemesanan_id) }}" 
