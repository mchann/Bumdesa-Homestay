...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.umkm.index') }}" class="btn btn-outline-success shadow-sm px-4">
    ...
    <div class="card shadow-lg mb-4 border-0" style="border-top: 4px solid #28a745;">
        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.umkm.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                @csrf
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-success @error('nama_produk') is-invalid @enderror" 
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control border-success @error('deskripsi') is-invalid @enderror" 
                                          id="deskripsi" name="deskripsi" rows="5" 
                                          placeholder="Deskripsikan produk secara detail termasuk keunggulan dan manfaatnya" required>{{ old('deskripsi') }}</textarea>
                            </div>
                            @error('deskripsi')
                                <div class="invalid-feedback d-block mt-2">
                                    <i class="fas fa-exclamation-triangle me-1"></i>{{ $message }}
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" 
                                       class="form-control border-success @error('no_telepon_owner') is-invalid @enderror" 
                                       id="no_telepon_owner" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control border-success @error('harga') is-invalid @enderror" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control border-success @error('kategori') is-invalid @enderror" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control border-success @error('stok') is-invalid @enderror" 
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control border-success @error('berat') is-invalid @enderror" 
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control border-success @error('satuan_berat') is-invalid @enderror" 
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control border-success @error('status') is-invalid @enderror" 
                ...
                <div class="form-group mt-5 pt-4 border-top">
                    <div class="d-flex gap-3">
                        ...
                        <a href="{{ route('admin.umkm.index') }}" class="btn btn-outline-success btn-lg px-5">
