            ...
            <div class="stat-card">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <h3 class="stat-value">{{ $totalPemesanan }}</h3>
            ...
            <div class="stat-card">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <h3 class="stat-value">{{ $pemilikAktif = $pemilikList->where('status', 'aktif')->count() }}</h3>
                        <div class="progress-container">
                            <div class="progress-info">
                                <span class="progress-label">Dari total {{ $totalPemilik = $pemilikList->count() }} pemilik</span>
                                <span class="progress-percentage">
                                    {{ $percentage = $totalPemilik > 0 ? round(($pemilikAktif / $totalPemilik) * 100) : 0 }}%
                                </span>
                            </div>
                            <div class="progress-bar">
        ...
        @forelse($recentActivities as $activity)
            <div class="activity-item">
                <div class="activity-icon 
                    @if($activity['type'] === 'pemesanan') bg-blue-100 text-blue-600
                    @elseif($activity['type'] === 'homestay') bg-green-100 text-green-600
                    @elseif($activity['type'] === 'pemilik') bg-purple-100 text-purple-600
                    @elseif($activity['type'] === 'pembayaran') bg-yellow-100 text-yellow-600
                    @else bg-gray-100 text-gray-600 @endif">
                    @if($activity['type'] === 'pemesanan')
                        <i class="fas fa-calendar-check"></i>
                    @elseif($activity['type'] === 'homestay')
                        <i class="fas fa-home"></i>
                    @elseif($activity['type'] === 'pemilik')
                        <i class="fas fa-user-plus"></i>
                    @elseif($activity['type'] === 'pembayaran')
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['tersedia'] }}</span>
                    <div class="w-24 h-2 bg-gray-200 rounded-full mt-1">
                        <div class="h-2 bg-green-500 rounded-full" 
                             style="width: {{ $homestayStats['dengan_kamar'] > 0 ? ($homestayStats['tersedia'] / $homestayStats['dengan_kamar'] * 100) : 0 }}%">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['dipakai'] }}</span>
                    <div class="w-24 h-2 bg-gray-200 rounded-full mt-1">
                        <div class="h-2 bg-blue-500 rounded-full" 
                             style="width: {{ $homestayStats['dengan_kamar'] > 0 ? ($homestayStats['dipakai'] / $homestayStats['dengan_kamar'] * 100) : 0 }}%">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['total_kamar'] }}</span>
                    <div class="w-24 h-2 bg-gray-200 rounded-full mt-1">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['kamar_tersedia'] }}</span>
                    <div class="w-24 h-2 bg-gray-200 rounded-full mt-1">
                        <div class="h-2 bg-green-400 rounded-full" 
                             style="width: {{ $homestayStats['total_kamar'] > 0 ? ($homestayStats['kamar_tersedia'] / $homestayStats['total_kamar'] * 100) : 0 }}%">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['kamar_dipesan'] }}</span>
                    <div class="w-24 h-2 bg-gray-200 rounded-full mt-1">
                        <div class="h-2 bg-blue-400 rounded-full" 
                             style="width: {{ $homestayStats['total_kamar'] > 0 ? ($homestayStats['kamar_dipesan'] / $homestayStats['total_kamar'] * 100) : 0 }}%">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['total'] }}</span>
                    <div class="w-24 h-2 bg-gray-200 rounded-full mt-1">
    ...
    <div class="bg-white rounded-xl shadow-xs p-6 border border-gray-100">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['pemilik_aktif_count'] }}</span>
                    <div class="w-24 h-2 bg-gray-200 rounded-full mt-1">
                        <div class="h-2 bg-green-500 rounded-full" 
                             style="width: {{ $homestayStats['total_pemilik'] > 0 ? ($homestayStats['pemilik_aktif_count'] / $homestayStats['total_pemilik'] * 100) : 0 }}%">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['pemilik_nonaktif_count'] }}</span>
                    <div class="w-24 h-2 bg-gray-200 rounded-full mt-1">
                        <div class="h-2 bg-red-500 rounded-full" 
                             style="width: {{ $homestayStats['total_pemilik'] > 0 ? ($homestayStats['pemilik_nonaktif_count'] / $homestayStats['total_pemilik'] * 100) : 0 }}%">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['pemilik_aktif'] }}</span>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['pemilik_nonaktif'] }}</span>
                </div>
            </div>
            ...
            <div class="pt-4 border-t border-gray-100">
                ...
                <div class="space-y-2">
                    @forelse($homestayStats['jenis_kamar_stats'] as $jenis)
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-600">{{ $jenis->nama_jenis }}</span> <!-- Diperbaiki -->
                        <span class="text-xs font-bold text-gray-900">{{ $jenis->total }} kamar</span>
                    </div>
                    @empty
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                ...
                <div class="text-right">
                    <span class="text-lg font-bold text-gray-900">{{ $homestayStats['total_pemilik'] }}</span>
                    <div class="w-24 h-2 bg-gray-200 rounded-full mt-1">
                        <div class="h-2 bg-gray-500 rounded-full" style="width: 100%"></div>
                    </div>
                </div>
...
<div class="card">
    ...
    <div class="quick-actions-grid">
        <a href="{{ route('admin.peraturan.index') }}" class="quick-action">
        ...
        <a href="{{ route('admin.pemilik.list') }}" class="quick-action">
