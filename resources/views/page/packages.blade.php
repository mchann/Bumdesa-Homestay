    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="package-card">
                    <div class="position-relative">
                        <img src="{{ asset('img/car-ijen.jpeg') }}" class="package-img" alt="Ijen Crater Tour">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="package-card">
                    <div class="position-relative">
                        <img src="{{ asset('img/car-terakota.jpg') }}" class="package-img" alt="Gandrung Terracotta Tour">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="package-card">
                    <div class="position-relative">
                        <img src="{{ asset('img/car-seruni.png') }}" class="package-img" alt="Sendang Seruni Tour">
