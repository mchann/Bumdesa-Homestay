...
<div class="bg-light pt-4 pb-5">
  ...
  <div class="col-xl-8 col-lg-7">
    ...
    <div class="row g-2">
      @foreach($allImages as $index => $image)
        <div class="col-3">
          <div class="ratio ratio-4x3 rounded-3 overflow-hidden cursor-pointer border {{ $index === 0 ? 'border-success border-2' : 'border-light' }}"
              data-bs-target="#homestayCarousel" data-bs-slide-to="{{ $index }}">
            <img src="{{ asset('storage/' . $image) }}" 
  ...
  <div class="col-xl-4 col-lg-5">
    ...
    <div class="bg-white rounded-4 p-3 shadow-sm border">
      ...
      <div class="d-flex justify-content-between align-items-center mb-1">
        ...
        <span class="fs-5 fw-bold text-success">Rp {{ number_format($homestay->kamar->min('harga'),0,',','.') }}</span>
      </div>
            ...
            <div class="row g-0">
                <div class="col-md-4 position-relative">
                    ...
                    <div class="position-absolute top-0 end-0 m-2">
                        <span class="badge {{ $firstKamar->status == 'tersedia' ? 'bg-success' : 'bg-danger' }}">
                            {{ $firstKamar->status == 'tersedia' ? 'Available' : 'Not Available' }} ({{ $stok }})
                        </span>
                    </div>
                </div>
                <div class="col-md-8">
    ...
    <div class="card-body">
        <div class="d-flex align-items-center mb-3">
            <div class="position-relative me-3">
                <img src="https://ui-avatars.com/api/?name={{ urlencode($homestay->pemilikProfile->nama_lengkap ?? 'Owner') }}&background=random" 
            ...
            <div>
                <div class="fw-bold">{{ $homestay->pemilikProfile->nama_lengkap ?? 'Homestay Owner' }}</div>
