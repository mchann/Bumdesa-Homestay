...
<body>
    <div class="container">
        ...
        <div class="breadcrumb">
            <a href="{{ route('umkm') }}">Produk UMKM</a>
            <span>></span>
            <a href="{{ route('umkm') }}?kategori={{ $product->kategori }}">{{ $product->kategori }}</a>
            <span>></span>
        ...
        <div class="product-detail">
            ...
            <div class="product-info">
                <div class="product-header">
                    @if($product->badge)
                        <div class="product-badge {{ $product->badge == 'Baru' ? 'new' : '' }}">
                            {{ $product->badge }}
                        </div>
                    @endif
                ...
                <div class="product-meta">
                    ...
                    <div class="meta-item">
                        ...
                        <span class="meta-value">{{ $product->berat }} {{ $product->satuan_berat }}</span>
                    </div>
                    <div class="meta-item">
                        <span class="meta-label">Terjual</span>
                        <span class="meta-value">{{ $product->terjual }} unit</span>
                    </div>
                    <div class="meta-item">
                ...
                <div class="order-section">
                    <div class="quantity-selector">
                        ...
                        <div class="quantity-controls">
                            ...
                            <input type="number" class="quantity-input" id="quantity" value="1" min="1" max="{{ $product->stok }}">
                            <button class="quantity-btn" onclick="increaseQuantity()">+</button>
                        </div>
                        <span class="stock-info">Tersisa {{ $product->stok }} unit</span>
                    </div>
                ...
                <div class="contact-info">
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-details">
                            <h4>Status Toko</h4>
                            <p>{{ $product->status == 'active' ? '🟢 Buka' : '🔴 Tutup Sementara' }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="related-products">
            ...
            <div class="related-grid">
                ...
                <a href="{{ route('umkm.detail', $relatedProduct->slug) }}" class="related-card">
                    <div class="related-image">
                        @if($relatedProduct->gambar)
                            <img src="{{ asset('storage/' . $relatedProduct->gambar) }}" alt="{{ $relatedProduct->nama_produk }}">
                        @else
                    ...
                    <div class="related-info">
                        <h4 class="related-title">{{ $relatedProduct->nama_produk }}</h4>
                        <div class="related-price">Rp {{ number_format($relatedProduct->harga, 0, ',', '.') }}</div>
                    </div>
                </a>
                @endforeach
            </div>
