            ...
            @endif
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group shadow-sm rounded-3 overflow-hidden">
                        ...
                        <input type="text" class="form-control border-0 py-3" name="search" placeholder="Kota, daerah, atau nama homestay" value="{{ request()->input('search') }}">
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group shadow-sm rounded-3 overflow-hidden">
                            ...
                            <input type="date" class="form-control border-0 py-2" id="checkin-date" name="checkin_date"
                                value="{{ request()->input('checkin_date', now()->toDateString()) }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select shadow-sm border-0 py-2" id="duration" name="duration" style="height: 46px;">
                            @foreach([1, 2, 3, 7, 14] as $day)
                                <option value="{{ $day }}" {{ request()->input('duration') == $day ? 'selected' : '' }}>
                                    {{ $day }} Malam
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group shadow-sm rounded-3 overflow-hidden">
                            ...
                            <input type="date" class="form-control border-0 py-2" id="checkout-date" name="checkout_date"
                                value="{{ request()->input('checkout_date', now()->addDays(1)->toDateString()) }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <button type="button" class="form-control text-start shadow-sm rounded-3 p-2 bg-white border-0" 
                            ...
                            <span id="guest-summary" class="text-dark">
                                {{ request()->input('dewasa', 2) }} Dewasa,
                                {{ request()->input('anak', 0) }} Anak,
                                {{ request()->input('kamar', 1) }} Kamar
                            </span>
                        </button>
                    </div>
                </div>
