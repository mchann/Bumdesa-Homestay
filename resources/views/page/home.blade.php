...
<section class="hero-video-container relative overflow-hidden">
    ...
    <video autoplay muted loop playsinline class="hero-video w-full h-full object-cover">
        <source src="{{ asset('img/pesona.mp4') }}" type="video/mp4">
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="{{ asset('img/car-ijen.jpeg') }}" class="card-img-top" alt="Kawah Ijen">
                    <div class="card-body">
    ...
    <div class="container">
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <img src="{{ asset('img/hv-jiwa-jawa.jpg') }}" alt="Kopi Ijen" class="w-100" style="height: 200px; object-fit: cover;">
                <div class="p-4">
            ...
            <!-- Product 2 -->
            <div class="product-card">
                <img src="{{ asset('img/hv-ijen-resto.jpg') }}" alt="Tenun Osing" class="w-100" style="height: 200px; object-fit: cover;">
                <div class="p-4">
                    <h5>Tenun Osing</h5>
            ...
            <!-- Product 3 -->
            <div class="product-card">
                <img src="{{ asset('img/card-package-01.png') }}" alt="Madu Ijen" class="w-100" style="height: 200px; object-fit: cover;">
                <div class="p-4">
            ...
            <!-- Product 4 -->
            <div class="product-card">
                <img src="{{ asset('img/hv-andung.jpg') }}" alt="Kerajinan Bambu" class="w-100" style="height: 200px; object-fit: cover;">
                <div class="p-4">
...
<section class="section bg-gray-50 py-12">
    <div class="container mx-auto px-4 max-w-6xl">
            ...
            @forelse ($homestays as $homestay)
                @if($homestay->kamar->count() > 0)
                    ...
                    <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
                        ...
                        <div class="p-5">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">{{ $homestay->nama_homestay }}</h3>
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <span class="text-gray-600 text-sm">({{ $homestay->review_count ?? 0 }} ulasan)</span>
                            </div>
                            
                            <div class="mb-4">
                                <p class="text-gray-600 mb-2">Kapasitas: {{ $cheapestRoom->kapasitas ?? 2 }} orang</p>
                                <p class="text-xl font-bold text-green-600">
                                    Rp{{ number_format($cheapestRoom->harga, 0, ',', '.') }} 
                                    <span class="text-sm font-normal text-gray-500">/malam</span>
                                </p>
                            </div>
                            
                            <a href="{{ route('homestay.details', $homestay->homestay_id) }}" 
        ...
        <div class="text-center mt-10">
            <a href="{{ route('homestay.index') }}" class="inline-flex items-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors duration-300">
                ...
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('img/haha.jpg') }}" class="rounded-circle mr-3" width="50" height="50" alt="Testimonial 1">
                            <div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('img/haha.jpg') }}" class="rounded-circle mr-3" width="50" height="50" alt="Testimonial 2">
                            <div>
