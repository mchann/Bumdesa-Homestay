...
<section id="about" class="section bg-light">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('img/car-seruni.png') }}" alt="Sendang Seruni" class="img-fluid rounded shadow">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row g-3">
            <div class="col-md-4 col-6">
                <img src="{{ asset('img/car-seruni.png') }}" class="gallery-img" alt="Mata air Sendang Seruni">
            </div>
            <div class="col-md-4 col-6">
                <img src="{{ asset('img/car-seruni.png') }}" class="gallery-img" alt="Pemandangan alam">
            </div>
            <div class="col-md-4 col-6">
                <img src="{{ asset('img/car-seruni.png') }}" class="gallery-img" alt="Suasana sejuk">
            </div>
        </div>
    </div>
</section>
